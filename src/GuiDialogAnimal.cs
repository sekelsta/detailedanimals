...
namespace DetailedAnimals {
    public class GuiDialogAnimal : GuiDialog {
        ...
        protected void ComposeGui() {
            ...
            if (animal.OwnedByOther((DetailedAnimalsModSystem.ClientAPI.World as ClientMain)?.Player)) {
        ...
        private void OnNameSet(string name) {
            ...
            DetailedAnimalsModSystem.ClientAPI.Network.GetChannel("detailedanimals").SendPacket<SetNameMessage>(message);
        }

        private void OnNoteSet(string note) {
            SetNoteMessage message = new SetNoteMessage() { entityId = animal.EntityId, note = note };
            DetailedAnimalsModSystem.ClientAPI.Network.GetChannel("detailedanimals").SendPacket<SetNoteMessage>(message);
        }
        ...
        private void OnPreventBreedingSet(bool value) {
            ...
            DetailedAnimalsModSystem.ClientAPI.Network.GetChannel("detailedanimals").SendPacket<ToggleBreedingMessage>(message);
        }
